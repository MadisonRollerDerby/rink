    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('long_name', models.CharField(help_text="Example: 'Women's Flat Track Derby Association'", max_length=50, verbose_name='Insurer Long Name')),
                ('details_url', models.CharField(help_text='Link to sign up for insurance or get more information.', max_length=200, verbose_name='Insurer Details URL')),
            ],
        ),
        migrations.CreateModel(
            name='League',
            fields=[
                ...
                ('stripe_private_key', fernet_fields.fields.EncryptedCharField(blank=True, help_text='Private API key for Stripe.com. Used for charging credit cards.', max_length=100, verbose_name='Stripe Private Key')),
                ...
                ('default_insurance_type', models.ForeignKey(blank=True, help_text='Default insurance type to show on Registration forms.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='league.InsuranceType')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(blank=True, help_text="Example: 'mrd', 'wreckers', 'juniors'. DO NOT CHANGE.", max_length=20, unique=True, verbose_name='Organization Slug')),
            ],
            options={
                'ordering': ['name'],
